   ...
   <div class="col-md-12">
      ...
      <div class="card">
         <div class="card-header">
            <strong>Thêm Hotel</strong>
         </div>
         <div class="card-body card-block">
            <form action="{{ route('admin.pages.hotel.them') }}"  enctype="multipart/form-data" method="POST" class="form-horizontal">
               <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
               <div class="row form-group">
                  <div class="col-12 col-md-12">
                     <label class="badge badge-info">Tên Hotel</label><br><br>
                     <input type="text" id="text-input" name="tenHotel" value="{{ old('tenHotel') }}" placeholder="Nhập Tên Hotel" class="form-control">
                  </div>
               </div>
               <div class="row form-group">
                  <div class="col-12 col-md-12">
               ...
               <div class="row form-group">
                  <div class="col-12 col-md-12">
                     ...
                     <input type="number" id="text-input" name="gia" value="{{ old('gia') }}" placeholder="Nhập Giá Hotel" class="form-control">
                  </div>
               </div>
               <div class="row form-group">
                  <div class="col-12 col-md-12">
               ...
               <div class="row form-group">
                  <div class="col-12 col-md-12">
                     ...
                     <input type="text" id="text-input" name="diaChi" value="{{ old('diaChi') }}" placeholder="Nhập Địa Chỉ" class="form-control">
                  </div>
               </div>
               <div class="row form-group">
                  <div class="col-12 col-md-12">
